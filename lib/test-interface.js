...
module.exports = function(componentTestUrlFactory, componentTestVisualPathFactory, visualThreshold, shouldRebaseVisuals) {
        ...
        suite.on('pre-require', function (context, file, mocha) {
            ...
            context.describe = context.context = function (title, fn) {
                ...
                suite.afterAll(async function() {
                    await context.Mochateer.resetRequests();
