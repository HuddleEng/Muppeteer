...
const argv = require('yargs')
    ...
    .example('$0 --t example/tests --f test.js --r example/tests/report --h false --s true', 'Specifies report directory, filter for file name and report directory with GUI')
    .option('testDir', {
        alias: 't',
    })
    .demandOption(['t'])
