...
const { argv } = require('yargs')
    ...
    .example(
        '$0 --t example/tests --r example/tests/report',
        'Specifies report directory and report directory'
    )
    .example(
        '$0 --t example/tests --f test.js --r example/tests/report',
        'Specifies report directory, filter for file name and report directory'
    )
    .example(
        '$0 --t example/tests --f test.js --r example/tests/report --h false --s true',
